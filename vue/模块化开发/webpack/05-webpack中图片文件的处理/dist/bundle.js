...
document.writeln('<h1>' + __WEBPACK_IMPORTED_MODULE_0__js_info__["b" /* name */] + '</h1>');
document.writeln('<p>' + __WEBPACK_IMPORTED_MODULE_0__js_info__["a" /* age */] + '</p>');
